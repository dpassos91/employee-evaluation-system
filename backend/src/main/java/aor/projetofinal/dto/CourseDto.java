...
/**
 * Data Transfer Object (DTO) representing a training course in the system.
 * Used for listing and viewing course details via the API.
 */
public class CourseDto {
    ...
    /** Indicates whether the course is active and can be assigned to users. */
